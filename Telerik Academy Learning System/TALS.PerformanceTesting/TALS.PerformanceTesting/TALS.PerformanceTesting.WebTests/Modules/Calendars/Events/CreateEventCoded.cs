...
namespace TALS.PerformanceTesting.WebTest
{
    ...
    public class CreateEventCoded : WebTest
    {

        public CreateEventCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            WebTestRequest request5 = new WebTestRequest("http://test.telerikacademy.com/Administration_Calendar/CustomEvents");
            ...
            WebTestRequest request5Dependent1 = new WebTestRequest("http://test.telerikacademy.com/Administration_Calendar/CustomEvents/GetCascadeCou" +
                    "rses");
            ...
            request5Dependent1.Headers.Add(new WebTestRequestHeader("Referer", "http://test.telerikacademy.com/Administration_Calendar/CustomEvents"));
            request5.DependentRequests.Add(request5Dependent1);
            WebTestRequest request5Dependent2 = new WebTestRequest("http://test.telerikacademy.com/Administration_Calendar/CustomEvents/CustomEvents_" +
                    "Read");
            request5Dependent2.ThinkTime = 9;
            ...
            request5Dependent2.Headers.Add(new WebTestRequestHeader("Referer", "http://test.telerikacademy.com/Administration_Calendar/CustomEvents"));
            FormPostHttpBody request5Dependent2Body = new FormPostHttpBody();
            request5Dependent2Body.FormPostParameters.Add("sort", "CustomEventId-desc");
            ...
            WebTestRequest request6 = new WebTestRequest("http://test.telerikacademy.com/Administration_Calendar/CustomEvents/GetCascadeCou" +
                    "rses");
            request6.ThinkTime = 59;
            ...
            request6.Headers.Add(new WebTestRequestHeader("Referer", "http://test.telerikacademy.com/Administration_Calendar/CustomEvents"));
            request6.QueryStringParameters.Add("isAllCoursesListItemIncluded", "false", false, false);
            yield return request6;
            request6 = null;

            WebTestRequest request7 = new WebTestRequest("http://test.telerikacademy.com/Administration_Calendar/CustomEvents/CustomEvents_" +
                    "Create");
            ...
            request7.Headers.Add(new WebTestRequestHeader("Referer", "http://test.telerikacademy.com/Administration_Calendar/CustomEvents"));
            ...
            request7Body.FormPostParameters.Add("CustomEventId", "0");
            request7Body.FormPostParameters.Add("UserId", "");
            request7Body.FormPostParameters.Add("Username", "");
            ...
            request7Body.FormPostParameters.Add("EndTime", "01/12/2015 15:30:00");
            request7Body.FormPostParameters.Add("Title", RandomStringProvider.GetRandomString(6));
            request7Body.FormPostParameters.Add("TrainingRoomId", "");
            request7Body.FormPostParameters.Add("CourseInstanceId_input", "");
            ...
            request8.Headers.Add(new WebTestRequestHeader("Referer", "http://test.telerikacademy.com/Administration_Calendar/CustomEvents"));
